...
| Hidden         | <a name="netifd_enabled"></a>netifd_enabled                        | boolean        | 0              | Enable/disable netifd integration.                                                                                                                                                                                                                                                                                                                                                                                                               |
| Hidden         | <a name="netifd_strict_enforcement"></a>netifd_strict_enforcement  | boolean        | 0              | Enable/disable netifd strict enforcement. See [Netifd integration](#netifd-integration) for more details.                                                                                                                                                                                                                                                                                                                                        |
| Hidden         | <a name="netifd_interface_default"></a>netifd_interface_default    | string         |                | Set the default netifd interface. See [Netifd integration](#netifd-integration) for more details.                                                                                                                                                                                                                                                                                                                                                |
| Hidden         | <a name="netifd_interface_default6"></a>netifd_interface_default6  | string         |                | Set the default netifd IPv6 interface. See [Netifd integration](#netifd-integration) for more details.                                                                                                                                                                                                                                                                                                                                           |
| Hidden         | <a name="netifd_interface_local"></a>netifd_interface_local        | list           |                | List of local interfaces for netifd integration. See [Netifd integration](#netifd-integration) for more details.                                                                                                                                                                                                                                                                                                                                 |
